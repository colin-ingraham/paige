...
class Scribe :
    def __init__(self, paige_search, library, client):
    ...
    def create_article(self, text):
        SYSTEM_PROMPT = """
            ...
            Write in a traditional fantasy wiki tone, serious but not academic. Ensure the writing is concise and easily able to parse.
            Write the article in traditional markdown, and do not provide anything in your response except for the article.
            ...
            NEVER create information or expand upon lore outside of the original context. 
        """
